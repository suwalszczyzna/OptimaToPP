...
namespace OptimaToPP
{
    static class PhoneChecker
    {
        ...
        static public bool IsMobile(string phoneNumber)
        {
            for (int i = 0; i < DirectionNumbers.Length; i++)
            {
                if ((phoneNumber.StartsWith(DirectionNumbers[i], Comparison)))
                {
